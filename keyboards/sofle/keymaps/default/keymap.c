...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EXLM, KC_UNDS, KC_HASH,  KC_DLR, KC_PERC,                       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
 ...
 */
[_RAISE] = LAYOUT(
  KC_BRID, KC_BRIU , KC_MCTL , KC_WSCH , KC_ASST , _______,                           KC_MPRV,  KC_MPLY  , KC_MNXT,  KC_MUTE ,  KC_VOLD ,KC_VOLU,
